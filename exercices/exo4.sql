CREATE DATABASE IF NOT EXISTS exo_four
...
editeur VARCHAR(50),
date_publication DATE, -- AAAA-MM-JJ
isbn_10 VARCHAR(10),
isbn_13 VARCHAR(15)
);
...
-- Bonus
SELECT COUNT(*) AS 'nombre de livres' FROM livre WHERE auteur = 'Agatha Christie';
...
-- Question 7
INSERT INTO livre (titre, auteur, editeur, date_publication, isbn_10, isbn_13)
VALUES ('Sorcières : La puissance invaincue des femmes', 'Mona Chollet', 'Zones', '2018-06-14', '2355221226', '978-2355221224');

-- Question 8
DELETE FROM livre WHERE auteur = 'Stendhal' AND titre = 'Le rouge et le noir';

-- Question Bonus
SELECT auteur, COUNT(auteur) FROM livre GROUP BY auteur HAVING auteur = 'Agatha Christie';
